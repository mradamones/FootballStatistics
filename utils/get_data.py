...
def get_gks():
    ...
    gks = goalkeeping.merge(adv_goalkeepers, on=['Rk', 'Player', 'Nation', 'Pos', 'Squad', 'Comp', 'Age', 'Born', '90s', 'GA', 'PKA'], how='left')
...
def get_def():
    ...
    defs = defs.merge(passing, on=['Rk', 'Player', 'Nation', 'Pos', 'Squad', 'Comp', 'Age', 'Born', '90s', 'Ast', 'xAG', 'PrgP'], how='left')
    defs = defs.merge(pass_types, on=['Rk', 'Player', 'Nation', 'Pos', 'Squad', 'Comp', 'Age', 'Born', '90s'], how='left')
    defs = defs.merge(possession, on=['Rk', 'Player', 'Nation', 'Pos', 'Squad', 'Comp', 'Age', 'Born', '90s', 'PrgC', 'PrgR'], how='left')
    # defs = defs.merge(play_time, on=['Rk', 'Player', 'Nation', 'Pos', 'Squad', 'Comp', 'Age', 'Born', '90s'], how='left') #check joining
    defs = defs.merge(misc, on=['Rk', 'Player', 'Nation', 'Pos', 'Squad', 'Comp', 'Age', 'Born', '90s', 'CrdY', 'CrdR'], how='left')
...
def get_mids():
    ...
    mids = mids.merge(passing, on=['Rk', 'Player', 'Nation', 'Pos', 'Squad', 'Comp', 'Age', 'Born', '90s', 'Ast', 'xAG', 'PrgP'], how='left')
    mids = mids.merge(pass_types, on=['Rk', 'Player', 'Nation', 'Pos', 'Squad', 'Comp', 'Age', 'Born', '90s'], how='left')
    mids = mids.merge(shooting, on=['Rk', 'Player', 'Nation', 'Pos', 'Squad', 'Comp', 'Age', 'Born', '90s', 'Gls', 'PK', 'PKattOff', 'xG', 'npxG'], how='left')
    ...
    mids = mids.merge(possession, on=['Rk', 'Player', 'Nation', 'Pos', 'Squad', 'Comp', 'Age', 'Born', '90s', 'PrgC', 'PrgR'], how='left')
    #mids = mids.merge(play_time, on=['Rk', 'Player', 'Nation', 'Pos', 'Squad', 'Comp', 'Age', 'Born', '90s'], how='left')
    mids = mids.merge(misc, on=['Rk', 'Player', 'Nation', 'Pos', 'Squad', 'Comp', 'Age', 'Born', '90s', 'CrdY', 'CrdR'], how='left')
...
def get_fwds():
    ...
    offs = offs.merge(shooting, on=['Rk', 'Player', 'Nation', 'Pos', 'Squad', 'Comp', 'Age', 'Born', '90s', 'Gls', 'PK', 'PKattOff', 'xG', 'npxG'], how='left')
    offs = offs.merge(passing, on=['Rk', 'Player', 'Nation', 'Pos', 'Squad', 'Comp', 'Age', 'Born', '90s', 'Ast', 'xAG', 'PrgP'], how='left')
    offs = offs.merge(pass_types, on=['Rk', 'Player', 'Nation', 'Pos', 'Squad', 'Comp', 'Age', 'Born', '90s'], how='left')
    offs = offs.merge(creation, on=['Rk', 'Player', 'Nation', 'Pos', 'Squad', 'Comp', 'Age', 'Born', '90s'], how='left')
    offs = offs.merge(possession, on=['Rk', 'Player', 'Nation', 'Pos', 'Squad', 'Comp', 'Age', 'Born', '90s', 'PrgC', 'PrgR'], how='left')
